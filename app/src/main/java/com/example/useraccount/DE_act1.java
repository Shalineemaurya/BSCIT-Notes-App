...
public class DE_act1 extends AppCompatActivity {
    PDFView ip;
    private TextToSpeech tts;
    private Button Btn1_read, btn1_pause;
    int result;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_d_e_act1);
        ...
        ip.fromAsset("digital_Electronics.pdf")
                .enableSwipe(true)
        ...
        switch (view.getId()) {
            case R.id.Btn1_read:
                if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                    ...
                    File file = new File("/assets/digital_Electronics.pdf");
